<section class="success" id="jobs">
    ...
    <div class="row text-center">
        <div class="col-sm-11 col-sm-offset-1">
            <div class="row">
                <div class="col-sm-4 jobs-crd osm-bg-white pad0 promoter"  ng-repeat="promoter in all_jobs.promoters">
                <a href="#portfolioModal1" class="portfolio-link">
                    ...
                    <div class="card-block row ">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{promoter.event_id}}" ng-click="apply_job(promoter.event_id,promoter.event_name);">Apply</button>
                        </div>
            ...
            <div class="col-sm-4 jobs-crd osm-bg-white pad0 emcess"  ng-repeat="emcess in all_jobs.emcess">
                <a href="#portfolioModal1" class="portfolio-link">
                    <img src="img/portfolio/emcess.jpg" class="img-responsive" alt="{{emcess.event_name}}" ng-attr-title="{{emcess.event_name}}">
                    <div class="card-block row ">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{emcess.event_id}}" ng-click="apply_job(emcess.event_id,emcess.event_name)">Apply</button>
                        </div>
            ...
            <div class="col-sm-4 jobs-crd osm-bg-white pad0 host"  ng-repeat="host in all_jobs.hostesses">
                <a href="#portfolioModal1" class="portfolio-link">
                    ...
                    <div class="card-block row ">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{host.event_id}}" ng-click="apply_job(host.event_id,host.event_name)">Apply</button>
                        </div>
            ...
            <div class="col-sm-4 jobs-crd osm-bg-white pad0 model"  ng-repeat="model in all_jobs.models">
                <a href="#portfolioModal1" class="portfolio-link">
                ...
                <div class="form-group text-center">
                    <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{model.event_id}}" ng-click="apply_job(model.event_id,model.event_name)">Apply</button>
                </div>
            ...
            <div class="col-sm-4 jobs-crd osm-bg-white pad0 pamphlet"  ng-repeat="pamphlet in all_jobs.pamphlets">
                <a href="#portfolioModal1" class="portfolio-link">
                    ...
                    <div class="card-block row ">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{pamphlet.event_id}}" ng-click="apply_job(pamphlet.event_id,pamphlet.event_name)">Apply</button>
                        </div>
            ...
            <div class="col-sm-4 jobs-crd osm-bg-white pad0 others"  ng-repeat="others in all_jobs.other_profiles">
            <a href="#portfolioModal1" class="portfolio-link">
                ...
                <div class="card-block row ">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-primary text-bold job-apply-btn"  href="javascript:void(0)" id="btn_{{others.event_id}}" ng-click="apply_job(others.event_id,others.event_name)">Apply</button>
                    </div>
