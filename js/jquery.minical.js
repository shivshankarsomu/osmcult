(function() {
  ...
  templates = {
    ...
    month: function(date) {
      ...
      $li.html("<article> <header> <h1>" + (date_tools.getMonthName(date)) + " " + (date.getFullYear()) + "</h1> <a href='#' class='minical_prev'></a> <a href='#' class='minical_next'></a> </header> <section style='padding:0'> <table> <thead> <tr> </tr> </thead> <tbody> </tbody> </table> </section> </article>");
